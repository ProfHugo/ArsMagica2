...
public final class ParticleOrbitPoint extends ParticleController {
	...
	public ParticleOrbitPoint(AMParticle particleEffect, double orbitX, double orbitY, double orbitZ, int priority,
			boolean exclusive) {
	...
	/**
	 * Set true for clockwise, false for counterclockwise. Not calling this
	 * method will cause the direction to be random.
	 *
	 * @param clockwise
	 */
