...
public class ParticleExpandingCollapsingRingAtPoint extends ParticleController {
	...
	public ParticleExpandingCollapsingRingAtPoint(AMParticle particleEffect, double x, double y, double z,
			double minDistance, double maxDistance, double speed, int priority, boolean exclusive) {
	...
	public ParticleController clone() {
		return new ParticleExpandingCollapsingRingAtPoint(particle, target.x, target.y, target.z, minDistance,
				maxDistance, speed, priority, collapseOnce);
	}
