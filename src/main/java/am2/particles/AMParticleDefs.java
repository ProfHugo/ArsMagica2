...
public class AMParticleDefs {
	...
	public static String getParticleForAffinity(Affinity aff) {
		if (aff.equals(Affinity.AIR))
			return "wind";
		if (aff.equals(Affinity.ARCANE))
			return "arcane";
		if (aff.equals(Affinity.EARTH))
			return "rock";
		if (aff.equals(Affinity.ENDER))
			return "pulse";
		if (aff.equals(Affinity.FIRE))
			return "explosion_2";
		if (aff.equals(Affinity.ICE))
			return "ember";
		if (aff.equals(Affinity.LIFE))
			return "sparkle";
		if (aff.equals(Affinity.LIGHTNING))
			return "lightning_hand";
		if (aff.equals(Affinity.NATURE))
			return "plant";
