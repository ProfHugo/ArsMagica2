...
public class ParticleApproachEntity extends ParticleController {
	...
	public ParticleApproachEntity(AMParticle particleEffect, Entity approachEntity, double approachSpeed,
			double targetDistance, int priority, boolean exclusive) {
