...
public class RenderManaVortex extends Render<EntityManaVortex> {
	...
	private static final ResourceLocation vortex = new ResourceLocation("arsmagica2",
			"textures/blocks/custom/Magic_Fabricator_2.png");
	...
	public void doRender(EntityManaVortex var1, double var2, double var4, double var6, float var8, float var9) {
		...
		renderArsMagicaEffect(tessellator, var1.ticksExisted, var1.getTicksToExist(), var1.getRotation(),
				var1.getScale(), var1.getManaStolenPercent());
	...
	private void renderArsMagicaEffect(Tessellator tessellator, int ticks, int life, float rotation, float scale,
			float percent) {
		GL11.glPushMatrix();
		...
		for (int var7 = 0; var7 < (var4 + var4 * var4) / 2.0F * 60.0F; ++var7) {
			...
			// tessellator.setColorRGBA_I(color, (int)(255.0F * (0.2F - (var5 *
			// 0.2f))));
			tessellator.getBuffer().pos(0.0D, 0.0D, 0.0D).color((int) (percent * 255), (int) (255 - (percent * 255)),
					(int) (255 - (percent * 255)), (int) (255.0F * (0.2F - (var5 * 0.2f))));
			// tessellator.setColorRGBA_I(color, 0);
			tessellator.getBuffer().pos(-0.866D * var9, var8, -0.5F * var9)
					.color((int) (percent * 255), (int) (255 - (percent * 255)), (int) (255 - (percent * 255)), 0)
					.endVertex();
			tessellator.getBuffer().pos(0.866D * var9, var8, -0.5F * var9)
					.color((int) (percent * 255), (int) (255 - (percent * 255)), (int) (255 - (percent * 255)), 0)
					.endVertex();
