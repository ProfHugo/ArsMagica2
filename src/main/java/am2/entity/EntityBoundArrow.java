...
public class EntityBoundArrow extends EntityArrow {
	...
	private static final DataParameter<Optional<ItemStack>> SPELL_STACK = EntityDataManager
			.createKey(EntityBoundArrow.class, DataSerializers.OPTIONAL_ITEM_STACK);
	...
	protected void arrowHit(EntityLivingBase living) {
		...
		if (stack == null || !stack.hasTagCompound())
			return;
		SpellUtils.applyStackStage(stack, (EntityLivingBase) shootingEntity, living, living.posX, living.posY,
				living.posZ, null, worldObj, true, true, this.ticksExisted);
	}
