...
public class SpawnBlacklists {
	private static ArrayListMultimap<Integer, Class<? extends Entity>> blacklistedDimensionSpawns = ArrayListMultimap
			.create();
	private static ArrayListMultimap<Integer, Class<? extends Entity>> blacklistedBiomeSpawns = ArrayListMultimap
			.create();
