...
public class CrystalWrenchRenderer implements ItemMeshDefinition {
	...
	private ModelResourceLocation loc_disconnect = new ModelResourceLocation("arsmagica2:crystal_wrench_disconnect",
			"inventory");
	private ModelResourceLocation loc_stored = new ModelResourceLocation("arsmagica2:crystal_wrench_stored",
			"inventory");
