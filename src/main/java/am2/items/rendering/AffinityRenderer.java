...
public class AffinityRenderer implements ItemMeshDefinition {
	...
	public AffinityRenderer addModels(Item item) {
		for (Affinity aff : ArsMagicaAPI.getAffinityRegistry().getValues())
			ModelBakery.registerItemVariants(item,
					new ModelResourceLocation(new ResourceLocation(aff.getRegistryName().getResourceDomain(),
							prefix + aff.getRegistryName().getResourcePath()), "inventory"));
		return this;
	}
	...
	public ModelResourceLocation getModelLocation(ItemStack stack) {
		...
		return new ModelResourceLocation(new ResourceLocation(aff.getRegistryName().getResourceDomain(),
				prefix + aff.getRegistryName().getResourcePath()), "inventory");
	}
