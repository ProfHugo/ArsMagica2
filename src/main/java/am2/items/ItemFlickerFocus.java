...
public class ItemFlickerFocus extends ItemArsMagica {
	...
	public String getItemStackDisplayName(ItemStack stack) {
		...
		if (operator == null)
			return "Trash";
		return String.format(I18n.translateToLocal("item.arsmagica2:FlickerFocusPrefix"),
				I18n.translateToLocal("item.arsmagica2:" + operator.getClass().getSimpleName() + ".name"));
	}
