...
public class ModelUtils {
	...
	public static final Gson GSON = new GsonBuilder().registerTypeAdapter(mapType, ModelTextureDeserializer.INSTANCE)
			.create();
	...
	static {
		...
		builderBlock.put(ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND,
				get(0, 2.5f, 0, 75, 45, 0, 0.375f));
		builderBlock.put(ItemCameraTransforms.TransformType.THIRD_PERSON_LEFT_HAND,
				get(0, 2.5f, 0, 75, 225, 0, 0.375f));
		...
		builderShield.put(ItemCameraTransforms.TransformType.FIRST_PERSON_RIGHT_HAND,
				get(-27.1f, 4.82f, -28, 0, 180, 5, 1.25f));
		builderShield.put(ItemCameraTransforms.TransformType.FIRST_PERSON_LEFT_HAND,
				get(-28.88f, 1.0f, -28, 0, 180, -5, 1.25f));
		...
		builderBlockingShield.put(ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND,
				get(-7, 18, -12, 45, 135, 0, 1));
		builderBlockingShield.put(ItemCameraTransforms.TransformType.THIRD_PERSON_LEFT_HAND,
				get(-32, 3, 4, 45, -135, 0, 1));
		builderBlockingShield.put(ItemCameraTransforms.TransformType.FIRST_PERSON_RIGHT_HAND,
				get(-34f, 5, -32, 0, 180, -5, 1.25f));
		builderBlockingShield.put(ItemCameraTransforms.TransformType.FIRST_PERSON_LEFT_HAND,
				get(-26.88f, 7f, -30, 0, 180, 5, 1.25f));
	...
	public static void transform(IModelState state, TransformType type, boolean leftHand) {
		...
		// flipX.m00 = -1;
		// Matrix4f matrix =
		// TRSRTransformation.blockCornerToCenter(transform).getMatrix();
		// if (!leftHand) {
