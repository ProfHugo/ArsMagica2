...
public class RenderUtils {
	...
	public static void drawBox(float minX, float minZ, float maxX, float maxZ, float zLevel, float minU, float minV,
	...
	public static void line2d(float xStart, float yStart, float xEnd, float yEnd, float zLevel, int color) {
		...
		GL11.glLineWidth(1f);
		GL11.glColor3d(((color & 0xFF0000) >> 16) / 255.0d, ((color & 0x00FF00) >> 8) / 255.0f,
	...
	public static void fractalLine2df(float xStart, float yStart, float xEnd, float yEnd, float zLevel, int color,
	...
	public static void fractalLine2dd(double xStart, double yStart, double xEnd, double yEnd, float zLevel, int color,
			float displace, float fractalDetail) {
		fractalLine2df((float) xStart, (float) yStart, (float) xEnd, (float) yEnd, (float) zLevel, color, displace,
				fractalDetail);
	}
	...
	public static void RenderRotatedModelGroup(TileEntity te, IBakedModel model, IBlockState defaultState,
			AMVector3 rotation) {
