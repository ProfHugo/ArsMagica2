...
public class GuiSpellCustomization extends GuiContainer {
	...
	private static final ResourceLocation background = new ResourceLocation("arsmagica2",
			"textures/gui/SpellCustomization.png");
			...
			if (page > 0) {
				...
				for (Object btn : this.buttonList) {
					if (btn instanceof GuiSpellImageButton) {
						if (((GuiSpellImageButton) btn).getPage() == page)
	...
	public void initGui() {
		...
		btnPrev = new GuiButtonVariableDims(0, l + 8, i1 + 26, I18n.translateToLocal("am2.gui.prev")).setDimensions(48,
				20);
		btnNext = new GuiButtonVariableDims(1, l + xSize - 56, i1 + 26, I18n.translateToLocal("am2.gui.next"))
				.setDimensions(48, 20);
