...
public class GuiParticleEmitter extends GuiScreen {
	...
	public void initGui() {
		...
		btnParticleBehaviour = new GuiButtonVariableDims(11, 50, 60,
				ParticleController.AuraControllerOptions[tile.getParticleBehaviour()]);
		btnParticleColorMode = new GuiButtonVariableDims(12, 50, 80,
				tile.getColorDefault() ? I18n.translateToLocal("am2.gui.default")
						: tile.getColorRandom() ? I18n.translateToLocal("am2.gui.random")
								: I18n.translateToLocal("am2.gui.custom"));
		hideBlock = new GuiButtonVariableDims(19, 50, 100,
				tile.getShow() ? I18n.translateToLocal("am2.gui.visible") : I18n.translateToLocal("am2.gui.hidden"));
		...
		sliParticleSpeed = new GuiSlideControl(22, width - 110, 180, 100, I18n.translateToLocal("am2.gui.speed"), 1.0f,
				0.25f, 10.0f);
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		case 13: // random color
			...
			btnParticleColorMode.displayString = tile.getColorDefault() ? "Default"
					: tile.getColorRandom() ? I18n.translateToLocal("am2.gui.random")
							: I18n.translateToLocal("am2.gui.custom");
			break;
		case 14: // scale
		...
		case 19: // hide/show
			flag = tile.getShow();
			tile.setShow(!flag);
			hideBlock.displayString = !flag ? I18n.translateToLocal("am2.gui.visible")
					: I18n.translateToLocal("am2.gui.hidden");
			break;
		case 20: // quantity
