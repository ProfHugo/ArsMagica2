...
public class GuiButtonCompendiumLink extends GuiButton {
	...
	public GuiButtonCompendiumLink(int id, int xPos, int yPos, FontRenderer fontRenderer, int page,
			CompendiumEntry entry, CompendiumCategory category) {
		super(id, xPos, yPos, fontRenderer.getStringWidth(entry == null ? category.getCategoryName() : entry.getName()),
				10, entry == null ? category.getCategoryName() : entry.getName());
