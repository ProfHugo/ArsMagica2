...
public class GuiStatedImageButton extends GuiButtonVariableDims {
	...
	public enum States {
		IDLE, MOUSEOVER, HOVER, CLICK, ACTIVE
	}
	...
	public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
		boolean isMousedOver = par2 >= this.xPosition && par3 >= this.yPosition && par2 < this.xPosition + this.width
		...
		if (!renderBorderOnly) {
			...
			line(this.xPosition + this.width, this.yPosition, this.xPosition + this.width, this.yPosition + this.height,
					color);
			line(this.xPosition + this.width, this.yPosition + this.height, this.xPosition,
