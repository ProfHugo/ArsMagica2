...
public class GuiFlickerHabitat extends GuiContainer {
	...
	private static final ResourceLocation background = new ResourceLocation("arsmagica2",
			"textures/gui/FlickerHabitat.png");
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
		...
		String colorCode = Minecraft.getMinecraft().theWorld
				.isBlockIndirectlyGettingPowered(flickerHabitat.getPos()) > 0 ? "\2474" : "\2472";
		...
		drawCenteredString(String.format(I18n.translateToLocal("am2.gui.flicker_powerperop"),
				String.format("%s%d\2470", colorCode, func.PowerPerOperation())), yPos);

		yPos += 12;

		boolean powered = PowerNodeRegistry.For(flickerHabitat.getWorld()).checkPower(flickerHabitat,
				func.PowerPerOperation());

		if (yPos > 40)
			yPos += 27;

		drawCenteredString(String.format(I18n.translateToLocal("am2.gui.flicker_optime"), String.format("%s%.2f\2470",
				colorCode, func.TimeBetweenOperation(powered, flickerHabitat.getNearbyUpgrades()) / 20.0f)), yPos);
