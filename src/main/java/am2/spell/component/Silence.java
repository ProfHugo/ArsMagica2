...
public class Silence extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { Blocks.WOOL, new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_ARCANEASH), Blocks.JUKEBOX,
				Blocks.WOOL };
	}
		...
		if (target instanceof EntityLivingBase && target.isNonBoss()) {
			if (!world.isRemote)
				((EntityLivingBase) target)
						.addPotionEffect(new BuffEffectSilence(PotionEffectsDefs.default_buff_duration,
