...
public class ChronoAnchor extends SpellComponent {
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		if (target instanceof EntityLivingBase) {
			...
			if (!world.isRemote) {
				...
				((EntityLivingBase) target).addPotionEffect(new BuffEffectTemporalAnchor(duration,
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.WHITE.getDyeDamage()), Items.CLOCK,
				Items.NETHER_STAR };
	}
