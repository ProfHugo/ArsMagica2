...
public class LightningDamage extends SpellComponent {
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		...
		((EntityLivingBase) target).addPotionEffect(
				new BuffEffectEntangled(20, SpellUtils.countModifiers(SpellModifiers.BUFF_POWER, stack)));
		return SpellUtils.attackTargetSpecial(stack, target, DamageSources.causeLightningDamage(caster),
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.YELLOW.getDyeDamage()), Items.IRON_INGOT,
				Items.STICK, new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_VINTEUM) };
	}
