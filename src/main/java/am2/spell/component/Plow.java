...
public class Plow extends SpellComponent {
	...
	public boolean applyEffectBlock(ItemStack stack, World world, BlockPos pos, EnumFacing blockFace, double impactX,
		...
		if ((block == Blocks.DIRT || block == Blocks.GRASS)) {
			/*
			 * if (!(blockAbove instanceof BlockFlower)){ return false; }
			 * blockAbove.breakBlock(world, blockx, blocky+1, blockz,
			 * blockAbove, 0); world.setBlock(blockx, blocky+1, blockz,
			 * Blocks.air);
			 */
			if (!world.isRemote) {
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.GREEN.getDyeDamage()), Items.STONE_HOE };
	}
