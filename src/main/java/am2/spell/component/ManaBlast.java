...
public class ManaBlast extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { ItemDefs.manaFocus, new ItemStack(ItemDefs.rune, 1, EnumDyeColor.PURPLE.getDyeDamage()),
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		...
		SpellUtils.attackTargetSpecial(stack, target, DamageSources.causeMagicDamage(caster),
