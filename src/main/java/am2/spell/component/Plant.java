...
public class Plant extends SpellComponent {
	...
	public boolean applyEffectBlock(ItemStack stack, World world, BlockPos pos, EnumFacing blockFace, double impactX,
		...
		if (soil != Blocks.AIR && seeds.size() > 0) {
			...
			if (soil != null && soil.canSustainPlant(world.getBlockState(pos), world, pos, EnumFacing.UP, seed)
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.GREEN.getDyeDamage()), Items.WHEAT_SEEDS,
				new ItemStack(Blocks.SAPLING, 1, OreDictionary.WILDCARD_VALUE), Items.WHEAT_SEEDS };
	}
