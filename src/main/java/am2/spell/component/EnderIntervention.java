...
public class EnderIntervention extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.PURPLE.getDyeDamage()), Blocks.OBSIDIAN,
				Blocks.OBSIDIAN, Items.FLINT_AND_STEEL, Items.ENDER_PEARL };
	}
