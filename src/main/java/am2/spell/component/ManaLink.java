...
public class ManaLink extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { BlockDefs.manaBattery, BlockDefs.essenceConduit, ItemDefs.crystalWrench,
				ItemDefs.manaFocus };
	}
	...
	public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
		...
		AMLineArc arc = (AMLineArc) ArsMagica2.proxy.particleManager.spawn(world, "textures/blocks/wipblock2.png",
				caster, target);
		if (arc != null) {
