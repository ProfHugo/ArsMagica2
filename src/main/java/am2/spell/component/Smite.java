...
public class Smite extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.PINK.getDyeDamage()),
				new ItemStack(Blocks.WOOL, 4, 6), Items.LEATHER_HELMET, Items.LEATHER_CHESTPLATE,
				Items.LEATHER_LEGGINGS, Items.LEATHER_BOOTS, Items.STICK, Items.DIAMOND_SWORD,
