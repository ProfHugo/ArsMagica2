...
public class ManaShield extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { ItemDefs.manaFocus, ItemDefs.battlemageArmor, ItemDefs.mageArmor };
	}
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		...
		EntityExtension.For((EntityLivingBase) target).addMagicShielding((consumed / 250)
				* SpellUtils.getModifiedInt_Add(1, stack, caster, target, world, SpellModifiers.BUFF_POWER));
		return true;
	}
