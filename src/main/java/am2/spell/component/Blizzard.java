...
public class Blizzard extends SpellComponent {
	...
	public Object[] getRecipe() {
		return new Object[] { AffinityShiftUtils.getEssenceForAffinity(Affinity.ICE),
				new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_BLUE_TOPAZ), Blocks.ICE,
				AffinityShiftUtils.getEssenceForAffinity(Affinity.ICE) };
	}

	private boolean spawnBlizzard(ItemStack stack, World world, EntityLivingBase caster, Entity target, double x,
			double y, double z) {
