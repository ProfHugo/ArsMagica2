...
public class WateryGrave extends SpellComponent implements IRitualInteraction {
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		if (target instanceof EntityLivingBase) {
			...
			if (!world.isRemote)
				((EntityLivingBase) target).addPotionEffect(new BuffEffectWateryGrave(duration,
			...
			if (particle != null) {
				...
				particle.AddParticleController(
						new ParticleLeaveParticleTrail(particle, "water_ball", false, 5, 2, false)
								...
								.setParticleRGB_F(1, 1, 1).setTicksBetweenSpawns(2));
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.BLUE.getDyeDamage()), Blocks.STONE,
				Items.LEATHER_BOOTS };
	}
