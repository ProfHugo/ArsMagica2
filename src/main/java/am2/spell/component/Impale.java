...
public class Impale extends SpellComponent {
	...
	public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
		...
		((EntityLivingBase) target).setArrowCountInEntity(arrowCount + 1);
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.RED.getDyeDamage()), Items.BOW,
				Items.ARROW };
	}
