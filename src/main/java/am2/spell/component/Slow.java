...
public class Slow extends SpellComponent implements IRitualInteraction {
	...
	public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
		...
		for (int i = 0; i < 25; ++i) {
			...
			if (particle != null) {
				...
				particle.AddParticleController(new ParticleOrbitEntity(particle, target, 0.2f, 2, false)
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.GREEN.getDyeDamage()), Items.SLIME_BALL };
	}
	...
	public ItemStack[] getReagents() {
		return new ItemStack[] { new ItemStack(Items.SLIME_BALL) };
	}
