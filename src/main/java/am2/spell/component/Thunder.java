...
public class Thunder extends SpellComponent {
	...
	public boolean applyEffectBlock(ItemStack stack, World world, BlockPos blockPos, EnumFacing blockFace,
		...
		DamageSource.lightningBolt.setDamageBypassesArmor();
		EntityLightningBolt bolt = new EntityLightningBolt(world, blockPos.getX(), blockPos.getY(), blockPos.getZ(),
				false);
		world.addWeatherEffect(bolt);
		return true;
	}
	...
	public Object[] getRecipe() {
		return new Object[] { new ItemStack(ItemDefs.rune, 1, EnumDyeColor.WHITE.getDyeDamage()),
				new ItemStack(Blocks.ANVIL), new ItemStack(Blocks.IRON_BARS),
