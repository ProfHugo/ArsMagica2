...
public class BuffPower extends SpellModifier {
	...
	public Object[] getRecipe() {
		return new Object[] { Items.GLASS_BOTTLE, Items.REDSTONE, Items.GLOWSTONE_DUST, Items.GHAST_TEAR,
				Items.SPIDER_EYE, Items.NETHER_WART, Items.GUNPOWDER, Items.EMERALD };
	}
