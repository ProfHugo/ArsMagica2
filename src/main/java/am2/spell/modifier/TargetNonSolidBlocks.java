...
public class TargetNonSolidBlocks extends SpellModifier {
	...
	public Object[] getRecipe() {
		return new Object[] { AffinityShiftUtils.getEssenceForAffinity(Affinity.WATER), Items.POTIONITEM,
				Blocks.RED_FLOWER, Blocks.BROWN_MUSHROOM, BlockDefs.cerublossom };
	}
