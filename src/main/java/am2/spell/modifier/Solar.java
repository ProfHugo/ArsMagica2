...
public class Solar extends SpellModifier {
	...
	public EnumSet<SpellModifiers> getAspectsModified() {
		return EnumSet.of(SpellModifiers.RANGE, SpellModifiers.RADIUS, SpellModifiers.DAMAGE, SpellModifiers.DURATION,
	...
	private float modifyValueOnTime(World world, float value) {
		...
		float multiplierFromTime = (float) (Math.cos(((x / 3800f) * (x / 24000f) - 13000f) * (180f / Math.PI)) * 1.5f)
				+ 1;
	...
	public Object[] getRecipe() {
		return new Object[] { AffinityShiftUtils.getEssenceForAffinity(Affinity.NATURE),
				new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_SUNSTONE), Items.CLOCK };
	}
