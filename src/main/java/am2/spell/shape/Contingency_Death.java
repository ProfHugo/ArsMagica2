...
public class Contingency_Death extends SpellShape {
	...
	public Object[] getRecipe() {
		return new Object[] { Items.CLOCK, AffinityShiftUtils.getEssenceForAffinity(Affinity.ENDER), Blocks.STONE,
				Blocks.STONE_SLAB, Blocks.STONE_SLAB, Blocks.STONE_SLAB, Items.BLAZE_POWDER, BlockDefs.tarmaRoot,
				new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_ARCANEASH), "E:" + PowerTypes.DARK.ID(), 5000 };
	}
