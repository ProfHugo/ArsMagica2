...
public class AbilitySunlightWeakness extends AbstractAffinityAbility {
	...
	public void applyTick(EntityPlayer player) {
		...
		AffinityAbilityModifiers.instance.applyOrRemoveModifier(attribute, AffinityAbilityModifiers.sunlightWeakness,
				player.worldObj.canBlockSeeSky(player.getPosition()) && (worldTime > 23000 || worldTime < 12500));
	}
	...
	public void removeEffects(EntityPlayer player) {
		...
		AffinityAbilityModifiers.instance.applyOrRemoveModifier(attribute,
				AffinityAbilityModifiers.iceAffinityColdBlooded, false);
	}
