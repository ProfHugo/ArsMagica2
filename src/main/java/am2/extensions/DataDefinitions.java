...
public class DataDefinitions {
	...
	static final SavedObject<Integer> AFFINITY_HEAL_COOLDOWN = ArsMagicaManager
			.createSavedObject(IntegerSerializer.INSTANCE);
	...
	static final SavedObject<Optional<ItemStack>> CONTENGENCY_STACK = ArsMagicaManager
			.createSavedObject(ItemStackSerializer.INSTANCE);
	...
	static final SavedObject<HashMap<Affinity, Double>> AFFINITY_DATA = ArsMagicaManager
			.createSavedObject(AffinityMapSerializer.INSTANCE);
	static final SavedObject<HashMap<SkillPoint, Integer>> POINT_TIER = ArsMagicaManager
			.createSavedObject(SkillPointMapSerializer.INSTANCE);
	static final SavedObject<HashMap<Skill, Boolean>> SKILL = ArsMagicaManager
			.createSavedObject(SkillMapSerializer.INSTANCE);

	static final SavedObject<HashMap<String, Integer>> COOLDOWNS = ArsMagicaManager
			.createSavedObject(StringIntegerMapSerializer.INSTANCE);
	static final SavedObject<HashMap<String, Boolean>> ABILITY_BOOLEAN = ArsMagicaManager
			.createSavedObject(StringBooleanMapSerializer.INSTANCE);
	static final SavedObject<HashMap<String, Float>> ABILITY_FLOAT = ArsMagicaManager
			.createSavedObject(StringFloatMapSerializer.INSTANCE);
	...
	public static final SavedObject<ArrayList<String>> COMPENDIUM = ArsMagicaManager
			.createSavedObject(StringArraySerializer.INSTANCE);
