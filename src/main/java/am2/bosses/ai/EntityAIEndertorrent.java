		...
		if (guardian.getAttackTarget() != null) {
			...
			if (guardian.getTicksInCurrentAction() > 15) {
				if ((guardian.getTicksInCurrentAction() - 15) % 10 == 0)
					SpellUtils.applyStackStage(NPCSpells.instance.enderGuardian_enderTorrent, guardian, null,
							guardian.posX, guardian.posY, guardian.posZ, null, guardian.worldObj, false, false,
							guardian.getTicksInCurrentAction());
