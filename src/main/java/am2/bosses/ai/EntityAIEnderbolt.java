		...
		if (guardian.getAttackTarget() != null) {
			...
			if (guardian.getTicksInCurrentAction() == 7) {
				...
				guardian.worldObj.playSound(guardian.posX, guardian.posY, guardian.posZ,
						((IArsMagicaBoss) guardian).getAttackSound(), SoundCategory.HOSTILE, 1.0f, 1.0f, false);
				SpellUtils.applyStackStage(NPCSpells.instance.enderGuardian_enderBolt, guardian, guardian,
