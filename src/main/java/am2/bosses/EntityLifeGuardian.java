...
public class EntityLifeGuardian extends AM2Boss {
	...
	private static final DataParameter<Integer> DATA_MINION_COUNT = EntityDataManager
			.createKey(EntityLifeGuardian.class, DataSerializers.VARINT);
	...
	protected void initSpecificAI() {
		...
		this.tasks.addTask(1, new EntityAICastSpell<EntityLifeGuardian>(this, NPCSpells.instance.healSelf, 16, 23, 100,
				BossActions.CASTING, new ISpellCastCallback<EntityLifeGuardian>() {
					@Override
					public boolean shouldCast(EntityLifeGuardian host, ItemStack spell) {
						return host.getHealth() < host.getMaxHealth();
					}
				}));
		this.tasks.addTask(2, new EntityAICastSpell<EntityLifeGuardian>(this, NPCSpells.instance.nauseate, 16, 23, 20,
				BossActions.CASTING, new ISpellCastCallback<EntityLifeGuardian>() {
					@Override
					public boolean shouldCast(EntityLifeGuardian host, ItemStack spell) {
		...
		this.tasks.addTask(3, new EntityAISummonAllies(this, EntityEarthElemental.class, EntityFireElemental.class,
				EntityManaElemental.class, EntityDarkling.class));
	}

	@Override
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		if (par1DamageSource.getSourceOfDamage() != null
				&& par1DamageSource.getSourceOfDamage() instanceof EntityLivingBase) {
	...
	public void onUpdate() {
		// Minion management - add any queued minions to the minion list and
		// prune out any fallen or nonexistant ones
