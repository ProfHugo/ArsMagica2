...
public interface IArsMagicaBoss {
	...
	/**
	 * Should set the current action as well as reset the number of ticks in the
	 * current action. If world is not remote should also send a packet to all
	 * nearby clients advising action change.
	 */
	...
	/**
	 * Is the passed in action valid based on any internal states? (Ex, plant
	 * guardian has thrown sickle)
	 */
