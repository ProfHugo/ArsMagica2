...
public class GenericImbuement extends ArmorImbuement {
	...
	public static void registerAll() {
		// all armors
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(manaRegen, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.FEET, EntityEquipmentSlot.LEGS,
						EntityEquipmentSlot.CHEST, EntityEquipmentSlot.HEAD }));
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(burnoutReduction, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.FEET, EntityEquipmentSlot.LEGS,
						EntityEquipmentSlot.CHEST, EntityEquipmentSlot.HEAD }));
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(soulbound, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.FEET, EntityEquipmentSlot.LEGS,
						EntityEquipmentSlot.CHEST, EntityEquipmentSlot.HEAD }));

		// chest
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(flickerLure, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.CHEST }));
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(magicXP, ImbuementTiers.FOURTH,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.CHEST }));

		// helmet
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(pinpointOres, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.HEAD }));
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(magitechGoggleIntegration,
				ImbuementTiers.FIRST, new EntityEquipmentSlot[] { EntityEquipmentSlot.HEAD }));
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(thaumcraftNodeReveal, ImbuementTiers.FOURTH,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.HEAD }));

		// legs
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(stepAssist, ImbuementTiers.FIRST,
				new EntityEquipmentSlot[] { EntityEquipmentSlot.LEGS }));

		// boots
		ImbuementRegistry.instance.registerImbuement(new GenericImbuement(runSpeed, ImbuementTiers.FIRST,
