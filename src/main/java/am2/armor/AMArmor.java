...
public class AMArmor extends ItemArmor implements ISpecialArmor {
	...
	public AMArmor(ArmorMaterial inheritFrom, ArsMagicaArmorMaterial enumarmormaterial, int par3,
	...
	public void damageArmor(EntityLivingBase entity, ItemStack stack, DamageSource source, int damage, int slot) {
		...
		} else if (source == DamageSource.fall || source == DamageSource.inWall || source == DamageSource.drown
