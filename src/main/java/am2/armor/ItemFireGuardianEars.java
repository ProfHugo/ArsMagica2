...
public class ItemFireGuardianEars extends AMArmor {
	...
	public ItemFireGuardianEars(ArmorMaterial inheritFrom, ArsMagicaArmorMaterial enumarmormaterial, int par3,
	...
	public void onArmorTick(World world, EntityPlayer plr, ItemStack stack) {
		...
		if (!plr.getActivePotionEffects().contains(PotionTypes.FIRE_RESISTANCE))
			plr.addPotionEffect(new PotionEffect(
					Potion.getPotionFromResourceLocation(new ResourceLocation("fire_resistance").toString())));
	}
}
