...
public class ContainerSpellSealedDoor extends AM2Container {
	...
	public ContainerSpellSealedDoor(InventoryPlayer inventoryplayer, TileEntitySpellSealedDoor door) {
		this.door = door;
		addSlotToContainer(new SlotGhostRune(door, 0, 62, 8)); // inventory,
																// index, x, y
		addSlotToContainer(new SlotGhostRune(door, 1, 80, 8)); // inventory,
																// index, x, y
		addSlotToContainer(new SlotGhostRune(door, 2, 98, 8)); // inventory,
																// index, x, y
