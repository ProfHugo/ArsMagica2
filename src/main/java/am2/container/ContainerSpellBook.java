...
public class ContainerSpellBook extends Container {
	...
	public ContainerSpellBook(InventoryPlayer inventoryplayer, ItemStack bookStack,
		...
		for (int i = 0; i < 8; ++i) {
			addSlotToContainer(
					new SlotOneItemClassOnly(spellBookStack, slotIndex++, 18, 5 + (i * 18), ItemSpellBase.class, 1));
		}

		// Spell Book Pages - reserve spells
		for (int i = 0; i < 4; ++i) {
			for (int k = 0; k < 8; k++) {
				addSlotToContainer(new SlotOneItemClassOnly(spellBookStack, slotIndex++, 138 + (i * 26), 5 + (k * 18),
						ItemSpellBase.class, 1));
			}
		}
	...
	/*
	 * @Override protected boolean mergeItemStack(ItemStack par1ItemStack, int
	 ...
	 * (!par4 && var6 < par3 || par4 && var6 >= par2)) { if (var6 !=
	 * this.specialSlotIndex){ var7 = (Slot)this.inventorySlots.get(var6); var8
	 * = var7.getStack();
	 * 
	 * if (var8 != null && var8.itemID == par1ItemStack.itemID &&
	 * (!par1ItemStack.getHasSubtypes() || par1ItemStack.getItemDamage() ==
	 * var8.getItemDamage()) && ItemStack.areItemStacksEqual(par1ItemStack,
	 * var8)) { int var9 = var8.stackSize + par1ItemStack.stackSize;
	 * 
	 ...
	 * var6 = par2; }
	 * 
	 * while (!par4 && var6 < par3 || par4 && var6 >= par2) { if (var6 !=
	 * this.specialSlotIndex){ var7 = (Slot)this.inventorySlots.get(var6); var8
	 * = var7.getStack();
	 * 
	 * if (var8 == null) { var7.putStack(par1ItemStack.copy());
	 * var7.onSlotChanged(); par1ItemStack.stackSize = 0; var5 = true; break; }
	 * }
	 * 
	 * if (par4) { --var6; } else { ++var6; } } }
	 * 
