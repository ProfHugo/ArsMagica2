...
public class BlockMageLight extends BlockAMSpecialRender {
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		AMParticle particle = (AMParticle) ArsMagica2.proxy.particleManager.spawn(worldIn, "sparkle",
				pos.getX() + 0.5 + (rand.nextDouble() * 0.2f - 0.1f), pos.getY() + 0.5,
				pos.getZ() + 0.5 + (rand.nextDouble() * 0.2f - 0.1f));
		if (particle != null) {
