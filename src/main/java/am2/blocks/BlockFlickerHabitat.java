...
public class BlockFlickerHabitat extends BlockAMPowered {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (heldItem != null && heldItem.getItem() == ItemDefs.crystalWrench) {
			...
			FMLNetworkHandler.openGui(playerIn, ArsMagica2.instance, IDDefs.GUI_FLICKER_HABITAT, worldIn, pos.getX(),
					pos.getY(), pos.getZ());
			return true;
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (habitat.hasFlicker()) {
			...
			EntityItem entityItem = new EntityItem(worldIn, pos.getX() + offsetX, pos.getY() + offsetY,
