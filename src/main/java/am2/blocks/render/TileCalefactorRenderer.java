...
public class TileCalefactorRenderer extends TileEntitySpecialRenderer<TileEntityCalefactor> {
	...
	@Override
	public void renderTileEntityAt(TileEntityCalefactor tile, double x, double y, double z, float partialTicks,
			int destroyStage) {
		if (renderItem == null)
		...
		model.renderModel(tile.getRotationX(), tile.getRotationY(), tile.getRotationZ(), 0.0625F); // renders
																									// and
																									// yes
																									// 0.0625
																									// is
