...
public class TileCraftingAltarRenderer extends TileEntitySpecialRenderer<TileEntityCraftingAltar> {
	...
	@Override
	public void renderTileEntityAt(TileEntityCraftingAltar te, double x, double y, double z, float partialTicks,
			int destroyStage) {
		...
		if (te.structureValid() && te.getMimicState() != null) {
			...
			Minecraft.getMinecraft().getBlockRendererDispatcher().getBlockModelRenderer().renderModel(
					Minecraft.getMinecraft().theWorld, model, te.getMimicState(), pos, t.getBuffer(), false);
