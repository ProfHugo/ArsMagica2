...
public class TileBlackAuremRenderer extends TileEntitySpecialRenderer<TileEntityBlackAurem> {
	...
	@Override
	public void renderTileEntityAt(TileEntityBlackAurem te, double x, double y, double z, float partialTicks,
			int destroyStage) {
	...
	private void renderArsMagicaEffect(Tessellator tessellator, float offset, float scale) {
		...
		Minecraft.getMinecraft().renderEngine
				.bindTexture(new ResourceLocation("arsmagica2:textures/blocks/custom/black_aurem.png"));
