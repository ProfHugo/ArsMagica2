...
public class TileEntityArmorImbuer extends TileEntityAMPower implements IInventory, IMultiblockStructureController {
	...
	/*
	 * @Override public ItemStack[] getRunesInKey(){ return new ItemStack[]{
	...
	/*
	 * @Override public boolean keystoneMustBeHeld(){ return false; }
	 * 
	 * @Override public boolean keystoneMustBeInActionBar(){ return false; }
	 */
