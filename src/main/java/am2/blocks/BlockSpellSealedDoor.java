...
public class BlockSpellSealedDoor extends BlockDoor implements ITileEntityProvider {
		...
		if (!worldIn.isRemote) {
			...
			if (KeystoneUtilities.instance.canPlayerAccess((IKeystoneLockable<?>) te, playerIn,
				...
				if (playerIn.isSneaking()) {
					FMLNetworkHandler.openGui(playerIn, ArsMagica2.instance, IDDefs.GUI_SPELL_SEALED_DOOR, worldIn,
	...
	//
	// @Override
	// public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int
	// p_149718_3_, int p_149718_4_){
	// return true;
	// }
