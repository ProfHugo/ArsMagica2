...
public class ModelDarkling extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		float transparencyFromTime = boundedTime > 12500 && boundedTime < 23500
				? (float) Math.abs(Math.cos(Math.toRadians(((boundedTime - 12500f) / 11000f) * 180f))) - 0.2f : 1.0f;
		...
		if (transparencyFromTime >= 1.0f
				|| Minecraft.getMinecraft().thePlayer.isPotionActive(PotionEffectsDefs.trueSight)) {
