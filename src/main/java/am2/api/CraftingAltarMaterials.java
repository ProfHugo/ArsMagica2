...
public class CraftingAltarMaterials {
	...
	static {
		...
		addCapsMaterial(BlockDefs.blocks.getDefaultState().withProperty(BlockArsMagicaBlock.BLOCK_TYPE,
		...
		addMainMaterial(Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA),
				Blocks.ACACIA_STAIRS.getDefaultState(), 1);
		addMainMaterial(Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH),
				Blocks.BIRCH_STAIRS.getDefaultState(), 1);
		addMainMaterial(Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE),
				Blocks.SPRUCE_STAIRS.getDefaultState(), 1);
		addMainMaterial(Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE),
				Blocks.JUNGLE_STAIRS.getDefaultState(), 1);
		addMainMaterial(
				Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK),
				Blocks.DARK_OAK_STAIRS.getDefaultState(), 1);
