...
public class AMVector3 {
	...
	public static AMVector3 crossProduct(AMVector3 vec1, AMVector3 vec2) {
		return new AMVector3(vec1.y * vec2.z - vec1.z * vec2.y, vec1.z * vec2.x - vec1.x * vec2.z,
	...
	/**
	 * Writes the vector3 to the specified compound - note that the way this
	 * function works, only one vector3 can be written to a compound at a time.
