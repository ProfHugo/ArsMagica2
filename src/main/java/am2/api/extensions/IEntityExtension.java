...
public interface IEntityExtension {
	...
	public static class Storage implements IStorage<IEntityExtension> {
		...
		@Override
		public void readNBT(Capability<IEntityExtension> capability, IEntityExtension instance, EnumFacing side,
				NBTBase nbt) {
			...
			if (!contingencyTag.hasKey("Type") || !contingencyTag.getString("Type").equals("null")) {
				instance.setContingency(ContingencyType.fromName(contingencyTag.getString("Type")),
						ItemStack.loadItemStackFromNBT(contingencyTag.getCompoundTag("Stack")));
			} else {
