...
public class PageText extends CompendiumPage<String> {
	...
	protected void renderPage(int posX, int posY, int mouseX, int mouseY) {
		...
		// int x_start_title = posX + 100 -
		// (mc.fontRendererObj.getStringWidth(element) / 2);
		// int x_start_line = posX + 35;
		// int y_start_line = posY + 50;
		// if (page > numPages) page = numPages;
		//
		// if (page == 0)
		// fontRendererObj.drawString(entrySkill != null ? entrySkill.getName()
		// : entry.getName(), x_start_title, y_start_title, 0x000000);
