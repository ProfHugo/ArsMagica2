...
public class SkillPoint {
	...
	public static final SkillPoint SILVER_POINT = new SkillPoint("Silver", TextFormatting.GRAY, 0x999999, -1, -1)
			.disableRender();
	...
	public static final SkillPoint SKILL_POINT_5 = new SkillPoint("Magenta", TextFormatting.LIGHT_PURPLE, 0xff00ff, 50,
			3);
