...
public class Affinity extends IForgeRegistryEntry.Impl<Affinity> implements Comparable<Affinity> {
	...
	public static final Affinity ARCANE = new Affinity("arcane", 0xb935cd).setDirectOpposite(NATURE_LOC)
			.addMajorOpposite(LIFE_LOC, EARTH_LOC, WATER_LOC, ICE_LOC).addMinorOpposite(AIR_LOC, ENDER_LOC);
	public static final Affinity WATER = new Affinity("water", 0x0b5cef).setDirectOpposite(FIRE_LOC)
			.addMajorOpposite(LIGHTNING_LOC, EARTH_LOC, ARCANE_LOC, ENDER_LOC).addMinorOpposite(AIR_LOC, ICE_LOC);
	public static final Affinity FIRE = new Affinity("fire", 0xef260b).setDirectOpposite(WATER_LOC)
			.addMajorOpposite(AIR_LOC, ICE_LOC, NATURE_LOC, LIFE_LOC).addMinorOpposite(EARTH_LOC, LIGHTNING_LOC);
	public static final Affinity EARTH = new Affinity("earth", 0x61330b).setDirectOpposite(AIR_LOC)
			.addMajorOpposite(WATER_LOC, ARCANE_LOC, LIFE_LOC, LIGHTNING_LOC).addMinorOpposite(NATURE_LOC, FIRE_LOC);
	public static final Affinity AIR = new Affinity("air", 0x777777).setDirectOpposite(EARTH_LOC)
			.addMajorOpposite(NATURE_LOC, FIRE_LOC, ICE_LOC, ENDER_LOC).addMinorOpposite(WATER_LOC, ARCANE_LOC);
	public static final Affinity LIGHTNING = new Affinity("lightning", 0xdece19).setDirectOpposite(ICE_LOC)
			.addMajorOpposite(WATER_LOC, ENDER_LOC, NATURE_LOC, EARTH_LOC).addMinorOpposite(LIFE_LOC, FIRE_LOC);
	public static final Affinity ICE = new Affinity("ice", 0xd3e8fc).setDirectOpposite(LIGHTNING_LOC)
			.addMajorOpposite(LIFE_LOC, FIRE_LOC, AIR_LOC, ARCANE_LOC).addMinorOpposite(WATER_LOC, ENDER_LOC);
	public static final Affinity NATURE = new Affinity("nature", 0x228718).setDirectOpposite(ARCANE_LOC)
			.addMajorOpposite(AIR_LOC, ENDER_LOC, LIGHTNING_LOC, FIRE_LOC).addMinorOpposite(LIFE_LOC, EARTH_LOC);
	public static final Affinity LIFE = new Affinity("life", 0x34e122).setDirectOpposite(ENDER_LOC)
			.addMajorOpposite(ARCANE_LOC, ICE_LOC, FIRE_LOC, EARTH_LOC).addMinorOpposite(NATURE_LOC, LIGHTNING_LOC);
	public static final Affinity ENDER = new Affinity("ender", 0x3f043d).setDirectOpposite(LIFE_LOC)
			.addMajorOpposite(NATURE_LOC, LIGHTNING_LOC, WATER_LOC, AIR_LOC).addMinorOpposite(ARCANE_LOC, ICE_LOC);
	...
	/**
	 * Rendering purpose Will return the color used by the occulus to render
	 * this affinity depth
	 * 
	 ...
	 * 
	 * @param tag
	 *            Root tag of the entity / item
	 * @param affinity
	 *            The affinity to add
	 * @param depth
	 *            The the depth of this affinity
	 */
	...
	/**
	 * Will list all the affinities the player / item has if given a correct
	 * {@link NBTTagCompound}
	 * 
	 * @param tag
	 *            Root tag of the entity / item
	...
	/**
	 * Will give the depth of an affinity the player / item has if given a
	 * correct {@link NBTTagCompound}
	 * 
	 * @param tag
	 *            Root tag of the entity / item
	...
	public ArrayList<Affinity> getAdjacentAffinities() {
		...
		for (ResourceLocation rl : ArsMagicaAPI.getAffinityRegistry().getKeys()) {
			Affinity aff = ArsMagicaAPI.getAffinityRegistry().getObject(rl);
			if (aff == NONE || majorOpposites.contains(rl) || minorOpposites.contains(rl) || directOpposite == rl
					|| aff == this)
				continue;
			returnList.add(aff);
		}
