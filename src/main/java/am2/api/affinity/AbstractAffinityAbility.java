...
public abstract class AbstractAffinityAbility extends IForgeRegistryEntry.Impl<AbstractAffinityAbility> {
	...
	/**
	 * If this Affinity Ability uses a key binding, return it, otherwise just
	 * return null
	 * 
	...
	/**
	 * Checks if the player can use this ability. Most of the time you won't
	 * need change this unless you are using toggle {@link KeyBinding}s, in that
	 * case consider using {@link AbstractToggledAffinityAbility}.
	 * 
	 * @param player
	 *            : the current player.
