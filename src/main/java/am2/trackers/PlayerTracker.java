...
public class PlayerTracker {
	...
	public void onPlayerLogout(PlayerLoggedOutEvent event) {
		...
		if (!event.player.worldObj.isRemote) {
			...
			for (Object o : list) {
				if (o instanceof EntityLivingBase && EntityUtils.isSummon((EntityLivingBase) o)
						&& EntityUtils.getOwner((EntityLivingBase) o) == event.player.getEntityId()) {
	...
	private ArrayList<String> addContributors(ArrayList<String> lines) {
		...
		// Prof_Hugo
		lines.add("78d9b71d-4f55-46f8-a606-82504d1a78d2, :AL,3 :CL,http://i.imgur.com/QBCa5O0.png,6,Prof_Hugo");
		return lines;
	}
