...
public class BuffEffectHaste extends BuffEffect {
	...
	private static final AttributeModifier hasteSpeedBoost = (new AttributeModifier(IDDefs.hasteID, "Haste Speed Boost",
			0.2D, 2));
	...
	public void applyEffect(EntityLivingBase entityliving) {
		...
		attributeinstance.applyModifier(
				new AttributeModifier(IDDefs.hasteID, "Haste Speed Boost", 0.2D + (0.35 * getAmplifier()), 2));
	}
