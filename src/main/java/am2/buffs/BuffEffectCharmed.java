...
public class BuffEffectCharmed extends BuffEffect {
	...
	public void applyEffect(EntityLivingBase entityliving) {
		if (getAmplifier() == CHARM_TO_PLAYER && entityliving instanceof EntityCreature
	...
	public void readCustomNBT(NBTTagCompound nbt) {
		try {
			charmer = (EntityLivingBase) FMLCommonHandler.instance().getMinecraftServerInstance().worldServers[0]
					.getEntityFromUuid(UUID.fromString(nbt.getString("Charmer")));
		} catch (Throwable t) {
		}
	}
