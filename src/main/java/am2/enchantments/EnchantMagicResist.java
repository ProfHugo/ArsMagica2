...
public class EnchantMagicResist extends Enchantment {
	...
	public EnchantMagicResist(Rarity rarity) {
		super(rarity, EnumEnchantmentType.ARMOR, new EntityEquipmentSlot[] { EntityEquipmentSlot.FEET,
	...
	public static float ApplyEnchantment(EntityLivingBase entity, float damage) {
		...
		if (totalMRLevel > 0) {
			...
			// log scale, it is kind of ridiculous, as 1/4 of the resources
			// reaps more than half the max benefit
