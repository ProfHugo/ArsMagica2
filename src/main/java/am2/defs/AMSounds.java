...
public class AMSounds {
	...
	public static final SoundEvent LIGHTNING_GUARDIAN_ATTACK_STATIC = register(
			"arsmagica2:mob.lightningguardian.attack_static");
	public static final SoundEvent LIGHTNING_GUARDIAN_LIGHTNING_ROD_1 = register(
			"arsmagica2:mob.lightningguardian.lightning_rod_1");
	public static final SoundEvent LIGHTNING_GUARDIAN_LIGHTNING_ROD_START = register(
			"arsmagica2:mob.lightningguardian.lightning_rod_start");
	...
	private static SoundEvent register(String str) {
		return GameRegistry
				.register(new SoundEvent(new ResourceLocation(str)).setRegistryName(new ResourceLocation(str)));
	}
}
