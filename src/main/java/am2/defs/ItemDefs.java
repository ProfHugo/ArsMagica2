...
public class ItemDefs {
	...
	private static final ArmorMaterial MAGITECH = EnumHelper.addArmorMaterial("magitech", "arsmagica2:magitech", 5,
			new int[] { 1, 2, 3, 1 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F);
	private static final ArmorMaterial ENDER = EnumHelper.addArmorMaterial("ender", "arsmagica2:ender", 7,
			new int[] { 1, 3, 5, 2 }, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F);
	private static final ArmorMaterial MAGE = EnumHelper.addArmorMaterial("mage", "arsmagica2:mage", 7,
			new int[] { 1, 3, 5, 2 }, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F);
	private static final ArmorMaterial BATTLEMAGE = EnumHelper.addArmorMaterial("battlemage", "arsmagica2:battlemage",
	...
	public static final ItemArsMagica spellStaffMagitech = new ItemSpellStaff(0, -1)
			.registerAndName("spell_staff_magitech");
	public static final ItemArsMagica flickerFocus = new ItemFlickerFocus().registerAndName("flicker_focus");
	public static final ItemFlickerJar flickerJar = (ItemFlickerJar) new ItemFlickerJar()
			.registerAndName("flicker_jar");
	...
	public static final ItemArsMagica liquidEssenceBottle = new ItemLiquidEssenceBottle()
			.registerAndName("liquid_essence_bottle");
	public static final ItemArsMagica bindingCatalyst = new ItemBindingCatalyst().registerAndName("binding_catalyst");
	public static final ItemArsMagica inscriptionUpgrade = new ItemInscriptionTableUpgrade()
			.registerAndName("inscription_upgrade");
	...
	public static final Item earthArmor = new ItemEarthGuardianArmor(ArmorMaterial.GOLD, ArsMagicaArmorMaterial.UNIQUE,
			0, EntityEquipmentSlot.CHEST).registerAndName("earth_armor");
	public static final Item enderBoots = new ItemEnderBoots(ENDER, ArsMagicaArmorMaterial.UNIQUE, 0,
			EntityEquipmentSlot.FEET).registerAndName("ender_boots");
	public static final Item fireEars = new ItemFireGuardianEars(ArmorMaterial.GOLD, ArsMagicaArmorMaterial.UNIQUE, 0,
			EntityEquipmentSlot.HEAD).registerAndName("fire_ears");
	...
	public static final Item waterOrbs = new ItemWaterGuardianOrbs(ArmorMaterial.GOLD, ArsMagicaArmorMaterial.UNIQUE, 0,
			EntityEquipmentSlot.LEGS).registerAndName("water_orbs");
	...
	public static final ItemCrystalPhylactery crystalPhylactery = (ItemCrystalPhylactery) new ItemCrystalPhylactery()
			.registerAndName("crystal_phylactery");
	...
	public static final ItemHellCowHorn hellCowHorn = (ItemHellCowHorn) new ItemHellCowHorn()
			.registerAndName("hell_cow_horn");
	...
	public static final Item mageHood = new ItemMageHood(MAGE, ArsMagicaArmorMaterial.MAGE, 0, EntityEquipmentSlot.HEAD)
			.registerAndName("helmet_mage");
	public static final Item mageArmor = new AMArmor(MAGE, ArsMagicaArmorMaterial.MAGE, 0, EntityEquipmentSlot.CHEST)
			.registerAndName("chest_mage");
	public static final Item mageLeggings = new AMArmor(MAGE, ArsMagicaArmorMaterial.MAGE, 0, EntityEquipmentSlot.LEGS)
			.registerAndName("legs_mage");
	public static final Item mageBoots = new AMArmor(MAGE, ArsMagicaArmorMaterial.MAGE, 0, EntityEquipmentSlot.FEET)
			.registerAndName("boots_mage");
	public static final Item battlemageHood = new ItemMageHood(BATTLEMAGE, ArsMagicaArmorMaterial.BATTLEMAGE, 0,
			EntityEquipmentSlot.HEAD).registerAndName("helmet_battlemage");
	public static final Item battlemageArmor = new AMArmor(BATTLEMAGE, ArsMagicaArmorMaterial.BATTLEMAGE, 0,
			EntityEquipmentSlot.CHEST).registerAndName("chest_battlemage");
	public static final Item battlemageLeggings = new AMArmor(BATTLEMAGE, ArsMagicaArmorMaterial.BATTLEMAGE, 0,
			EntityEquipmentSlot.LEGS).registerAndName("legs_battlemage");
	public static final Item battlemageBoots = new AMArmor(BATTLEMAGE, ArsMagicaArmorMaterial.BATTLEMAGE, 0,
			EntityEquipmentSlot.FEET).registerAndName("boots_battlemage");
	...
	public static void initClient() {
		...
		Minecraft.getMinecraft().getItemColors().registerItemColorHandler(new CrystalPhylacteryColorizer(),
				crystalPhylactery);
		...
		// Iterator<Affinity> iter =
		// ArsMagicaAPI.getAffinityRegistry().getValues().iterator();
		// int effMeta = 0;
		// for (int i = 0; i <
		// ArsMagicaAPI.getAffinityRegistry().getValues().size(); i++) {
		// if (!iter.hasNext())
		// break;
		// Affinity entry = iter.next();
		// ModelBakery.registerItemVariants(affinityTome, new
		// ModelResourceLocation("arsmagica2:affinity_tome_" + entry.getName(),
		// "inventory"));
		// renderItem.getItemModelMesher().register(affinityTome, i, new
		// ModelResourceLocation("arsmagica2:affinity_tome_" + entry.getName(),
		// "inventory"));
		// if (entry.equals(Affinity.NONE)) {
		// continue;
		// }
		// ModelBakery.registerItemVariants(essence, new
		// ModelResourceLocation("arsmagica2:essence_" + entry.getName(),
		// "inventory"));
		// renderItem.getItemModelMesher().register(essence, effMeta, new
		// ModelResourceLocation("arsmagica2:essence_" + entry.getName(),
		// "inventory"));
		// effMeta++;
		// }
		renderItem.getItemModelMesher().register(essence, new AffinityRenderer("essence_").addModels(essence));
		renderItem.getItemModelMesher().register(affinityTome,
				new AffinityRenderer("affinity_tome_").addModels(affinityTome));
		for (int i = 0; i < 16; i++) {
			ModelBakery.registerItemVariants(rune, new ModelResourceLocation(
					"arsmagica2:rune_" + EnumDyeColor.byDyeDamage(i).getName().toLowerCase(), "inventory"));
			renderItem.getItemModelMesher().register(rune, i, new ModelResourceLocation(
					"arsmagica2:rune_" + EnumDyeColor.byDyeDamage(i).getName().toLowerCase(), "inventory"));
		}
		for (int i = 0; i < ItemOre.names.length; i++) {
			ModelResourceLocation loc = new ModelResourceLocation(
					new ResourceLocation("arsmagica2", "item_ore_" + ItemOre.names[i]), "inventory");
			ModelBakery.registerItemVariants(itemOre, loc);
			renderItem.getItemModelMesher().register(itemOre, i, loc);
		}

		DefaultWithMetaRenderer coreRenderer = new DefaultWithMetaRenderer(
				new ModelResourceLocation(core.getRegistryName() + "_base", "inventory"));
		for (int i = 0; i < 3; i++) {
			ModelResourceLocation loc = new ModelResourceLocation(core.getRegistryName().toString()
					+ (i == ItemCore.META_BASE_CORE ? "_base" : (i == ItemCore.META_HIGH_CORE ? "_high" : "_pure")),
					"inventory");
			ModelBakery.registerItemVariants(core, loc);
			coreRenderer.addModel(i, loc);
		}
		ModelBakery.registerItemVariants(core,
				new ModelResourceLocation(core.getRegistryName() + "_base", "inventory"));
		...
		DefaultWithMetaRenderer crystalPhylacteryRenderer = new DefaultWithMetaRenderer(
				new ModelResourceLocation(crystalPhylactery.getRegistryName(), "inventory"));
		for (int i = 1; i < 4; i++) {
			ModelResourceLocation loc = new ModelResourceLocation(
					crystalPhylactery.getRegistryName().toString() + (i == ItemCrystalPhylactery.META_QUARTER
							? "_quarter" : (i == ItemCrystalPhylactery.META_HALF ? "_half" : "_full")),
					"inventory");
			ModelBakery.registerItemVariants(crystalPhylactery, loc);
			crystalPhylacteryRenderer.addModel(i, loc);
		}
		ModelBakery.registerItemVariants(crystalPhylactery,
				new ModelResourceLocation(crystalPhylactery.getRegistryName(), "inventory"));
		renderItem.getItemModelMesher().register(crystalPhylactery, crystalPhylacteryRenderer);

		DefaultWithMetaRenderer catalystRenderer = new DefaultWithMetaRenderer(
				new ModelResourceLocation(bindingCatalyst.getRegistryName(), "inventory"));
		for (int i = 0; i < 7; i++) {
			ModelResourceLocation loc = new ModelResourceLocation(
					bindingCatalyst.getRegistryName() + "_" + ItemBindingCatalyst.NAMES[i], "inventory");
			ModelBakery.registerItemVariants(bindingCatalyst, loc);
			catalystRenderer.addModel(i, loc);
		}
		ModelBakery.registerItemVariants(bindingCatalyst,
				new ModelResourceLocation(bindingCatalyst.getRegistryName(), "inventory"));

		DefaultWithMetaRenderer inforbRenderer = new DefaultWithMetaRenderer(
				new ModelResourceLocation(infinityOrb.getRegistryName(), "inventory"));
		for (Entry<Integer, SkillPoint> entry : SkillPointRegistry.getSkillPointMap().entrySet()) {
			if (entry.getKey().intValue() < 0)
				continue;
			ModelResourceLocation loc = new ModelResourceLocation(
					infinityOrb.getRegistryName() + "_" + entry.getValue().toString().toLowerCase(), "inventory");
		...
		for (int i = 0; i < 3; i++) {
			ModelResourceLocation loc = new ModelResourceLocation(inscriptionUpgrade.getRegistryName() + "_" + (i + 1),
					"inventory");
	...
	private static void registerTexture(Item item) {
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(item,
				new IgnoreMetadataRenderer(new ModelResourceLocation(item.getRegistryName(), "inventory")));
	}

	@SideOnly(Side.CLIENT)
	private static void registerTexture(Item item, int meta, String suffix) {
		DefaultWithMetaRenderer renderer = new DefaultWithMetaRenderer(
				new ModelResourceLocation(item.getRegistryName(), "inventory"));
		renderer.addModel(meta, new ModelResourceLocation(item.getRegistryName().toString() + suffix, "inventory"));
		ModelBakery.registerItemVariants(item,
				new ModelResourceLocation(item.getRegistryName().toString() + suffix, "inventory"),
				new ModelResourceLocation(item.getRegistryName(), "inventory"));
